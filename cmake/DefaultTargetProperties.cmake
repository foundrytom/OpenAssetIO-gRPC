...
function(openassetio_grpc_set_default_target_properties target_name)
    #-------------------------------------------------------------------
    # C++ standard
    ...
    set_target_properties(
		...
		# Ensures emitted to avoid mis-matches between compiler and
		# linter defaults.
		CXX_STANDARD 17
    ...
    #-------------------------------------------------------------------
    # Compiler warnings
    openassetio_grpc_set_default_compiler_warnings(${target_name})
    ...
    if (CMAKE_CXX_COMPILER_ID STREQUAL "GNU" AND
        ...
        if (OPENASSETIO_GRPC_GLIBCXX_USE_CXX11_ABI)
    ...
    if (TARGET openassetio-grpc-cpplint)
        add_dependencies(${target_name} openassetio-grpc-cpplint)
    endif ()

    if (TARGET openassetio-grpc-clangformat)
        add_dependencies(${target_name} openassetio-grpc-clangformat)
    endif ()
